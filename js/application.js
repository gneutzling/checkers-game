...
(function() {
    ...
    app.verifyNewCapture = function() {
        var domNextPiece = null, domNextSquare = null, domFuturePiece = null, domFutureSquare = null, dataValue = null;
        nextSquare = [], futureSquare = [];
    ...
    app.getCaptured = function() {
        var dataValue = null, captured = null, coordinates = {
            x: null,
            y: null
        };
        if (app.isKing(app.selectedPiece)) {
