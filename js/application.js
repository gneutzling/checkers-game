(function() {
    ...
    var scope = document.getElementById(settings.scope), board = document.getElementsByClassName(settings.board)[0], pieces = document.getElementsByClassName(settings.pieces)[0];
    init = function() {
        create();
        attach();
        bind();
